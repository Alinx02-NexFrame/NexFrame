        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AwbNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    ...
                    ArrivalTime = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    BreakdownStatus = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CustomsStatus = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    StorageStartDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    FreeTimeDays = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    ReadyToPickup = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyRole = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ConfirmationNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    AwbNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
